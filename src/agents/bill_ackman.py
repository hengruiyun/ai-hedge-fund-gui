...
def generate_ackman_output(
    ...
    template = ChatPromptTemplate.from_messages([
        (
            ...
            IMPORTANT: Please respond in Chinese (Simplified Chinese). All your reasoning and analysis should be in Chinese to help Chinese-speaking users better understand your investment insights.
            """
        ),
        (
            "human",
